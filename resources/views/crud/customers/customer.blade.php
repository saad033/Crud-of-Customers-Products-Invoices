...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            ...
            <a href="/" class="bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none
                   text-white text-sm py-1 px-2 rounded">Add Customers</a>
                <div class="w-full mt-6">
                    <p class="text-xl pb-3 flex items-center">
                        <i class="fas fa-list mr-3"></i> Customer's List
                    </p>
                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody class="text-gray-700">
                                <tr>
                                    ...
                                    <td class="w-1/3 text-left py-3 px-4">{{$customer->address}}</td>
                                    <td class="text-left py-3 px-4"><a class="hover:text-blue-500" href="tel:622322662">{{$customer->phone_number}}</a>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                     ...
                                     <a href="{{url('customer/edit',$customer->id)}}" class="bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none
                                            text-white text-sm py-1 px-2 rounded">Edit</a>
                                    <a href="{{url('customer/delete',$customer->id)}}" class="bg-red-500 hover:bg-red-400 focus:shadow-outline focus:outline-none
