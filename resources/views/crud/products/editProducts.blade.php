...
<div class="bg-green-200 py-32 px-10 min-h-screen ">
    <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden md:max-w-lg">
        <form  method="POST" action="" enctype="multipart/form-data">
            ...
            <input type="text" name="product_name" value="{{$product->product_name}}"class="h-12 px-3 w-full border-gray-200 border rounded focus:outline-none focus:border-gray-300">
            </div>
            <div class="mb-2"> <span class="text-sm">Short Description</span>
            <input type="text" name="short_description" value="{{$product->short_description}}" class="h-12 px-3 w-full border-gray-200 border rounded focus:outline-none focus:border-gray-300">
            </div>
            <div class="mb-2"> <span class="text-sm">Sale Price</span>
            <input type="text" name="sale_price"   value="{{$product->sale_price}}" class="h-12 px-3 w-full border-gray-200 border rounded focus:outline-none focus:border-gray-300">
            </div>
            <div class="mb-2"> <span class="text-sm">Quantity</span>
            <input type="number" name="quantity"  value="{{$product->quantity}}" class="h-12 px-3 w-full border-gray-200 border rounded focus:outline-none focus:border-gray-300">
            </div>
            ...
            <div class="relative h-40 rounded-lg border-dashed border-2 border-gray-200 bg-white flex justify-center items-center hover:cursor-pointer">
                ...
                </div> <input type="file" name="file"  value="{{$product->images}} class="h-full w-full opacity-0" required>
            </div>
