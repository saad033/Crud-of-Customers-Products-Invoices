...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            ...
            <a href="product" class="bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none
                   text-white text-sm py-1 px-2 rounded">Add Products</a>
                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody class="text-gray-700">
                                <tr>
                                    ...
                                    <td class="w-1/3 text-left py-3 px-4">{{$product->short_description}}</td>
                                    <td class="text-left py-3 px-4"><a class="hover:text-blue-500" href="tel:622322662">{{$product->sale_price}}</a>
                                    <td class="text-left py-3 px-4"><a class="hover:text-blue-500" href="tel:622322662">{{$product->quantity}}</a> 
                                    <td class="text-left py-3 px-4"><a class="hover:text-blue-500" href="tel:622322662">{{$product->images}}</a> 
                                </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                     ...
                                     <a href="{{url('product/edit',$product->id)}}" class="bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none
                                            text-white text-sm py-1 px-2 rounded">Edit</a>
                                    <a href="{{url('product/delete',$product->id)}}" class="bg-red-500 hover:bg-red-400 focus:shadow-outline focus:outline-none
